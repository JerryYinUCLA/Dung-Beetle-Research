...
Trial_Num = Write_To_Excel_6(Trial_Num,'Persist',Radius,Veloc,Delta_t,Sigma,num,Time_Pen,0,0,Time_T,Path_T,CI_T1,CI_T2,CI_L1,CI_L2,0);
...
%                 [Theta(Round+1,1),x_partial,y_partial] = Bimodal_Drifting(Theta(Round,1),2*Sigma,Delta_t, Sigma); %Bimodal Drifting
    ...
    Trial_Num = Write_To_Excel_6(Trial_Num,'Persist',Radius,Veloc,Delta_t,Sigma,num,Time_Pen,min_Int,Sigma_ADJ,min_Time_Total,min_Path_Total,CI_T1,CI_T2,CI_L1,CI_L2,mean_check);
